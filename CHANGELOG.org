...
** 2026-September
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-09-16.2327][2026-09-16.2327]]
+ [[https://github.com/clojars/clojars-web/pull/969][Include username in email footer]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-09-20.2330][2026-09-20.2330]]
+ [[https://github.com/clojars/clojars-web/pull/971][Consider all confirmed emails on GitLab login, not just primary]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-09-22.2332][2026-09-22.2332]]
+ [[https://github.com/clojars/clojars-web/commit/67727beb0285264374326efe201a06ebabe5791a][Address CVEs]] ([[https://github.com/tobias][Toby Crawley]])

** 2026-August
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-08-21.2320][2026-08-21.2320]]
+ [[https://github.com/clojars/clojars-web/pull/964][Move session storage to PostgreSQL instead of using an atom]] ([[https://github.com/tobias][Toby Crawley]])

** 2026-July
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-07-09.2294][2026-07-09.2294]]
+ [[https://github.com/clojars/clojars-web/issues/928][Enable deploy notification emails for all existing users]]. Users that had Clojars accounts before this opt-in feature was added will now receive deploy notifications for groups they are members of. Users can still opt out via their Clojars settings. ([[https://github.com/danielcompton][Daniel Compton]])
+ [[https://github.com/clojars/clojars-web/pull/950][Move MFA to separate page on login]]. This reduces confusion for users not using MFA. ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-07-21.2299][2026-07-21.2299]]
+ [[https://github.com/clojars/clojars-web/pull/961][Remove Apache httpclient usage]] ([[https://github.com/tobias][Toby Crawley]])
+ [[https://github.com/clojars/clojars-web/pull/962][Update to official one-time release]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-07-21.2301][2026-07-21.2301]]
+ [[https://github.com/clojars/clojars-web/commit/0c7e45ae0a57775cb4d04d410fb605cff95ea413][Fix Fastly purging]]. This was a bug introduced by the removal of Apache httpclient. ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-07-25.2306][2026-07-25.2306]]
+ [[https://github.com/clojars/clojars-web/pull/960][Don't allow unstable versions in transitive dependencies]] ([[https://github.com/tobias][Toby Crawley]])

** 2026-May

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-05-15.2269][2026-05-15.2269]] 
  ...
  + [[https://github.com/clojars/clojars-web/pull/948][Allow deploys that contain both GPG and SSH signatures]] ([[https://github.com/tobias][Toby Crawley]])
    
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-05-16.2273][2026-05-16.2273]] 
  + [[https://github.com/clojars/clojars-web/pull/945][Send email when deploy token created]] ([[https://github.com/ispandey81][Indra]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-05-24.2278][2026-05-24.2278]] 
  + [[https://github.com/clojars/clojars-web/pull/949][Improve layout of group verification and MFA pages]] ([[https://github.com/tobias][Toby Crawley]])
...
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-04-06.2250][2026-04-06.2250]]
+ [[https://github.com/clojars/clojars-web/commit/e8e99c83332dae3d21cce6c707875a31d1bcc784][Allow deploys to span HTTP sessions]]. This fix was needed to support tooling that doesn't use the same session cookie across the deploy. ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-04-11.2252][2026-04-11.2252]]
+ [[https://github.com/clojars/clojars-web/commit/d12c255601e495edc57d3062fc4a81cce5f428e2][Use fork of one-time library for MFA token creation]]. This is to remove a dependency on a lib that requires loading from jitpack.io, and is dependent on vulnerable versions of batik. ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-04-13.2256][2026-04-13.2256]]
+ [[https://github.com/clojars/clojars-web/pull/935][Lock tmp upload dir creation to prevent erroneous failed deploys]]. This could impact anyone using pomegrate 1.3.26. ([[https://github.com/tobias][Toby Crawley]])

** 2026-March
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-03-21.2243][2026-03-21.2243]]
+ [[https://github.com/clojars/clojars-web/pull/923][Use]] a [[https://github.com/clojars/http-kit][fork]] of http-kit instead of Jetty. This reduces our dependency load, and removes Jetty as a source of CVEs. We have a fork of http-kit to support custom status messages. ([[https://github.com/tobias][Toby Crawley]])
  
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-03-21.2244][2026-03-21.2244]]
+ [[https://github.com/clojars/clojars-web/commit/d8cf38dda505c3d50715421ab05c4a1c7bb48e1d][Upgrade jakarta.mail to address CVE-2025-7962]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-03-30.2247][2026-03-30.2247]]
+ [[https://github.com/clojars/clojars-web/pull/924][Implement RFC 9457 Problem Details for deploy validation failures]] ([[https://github.com/tobias][Toby Crawley]])

** 2026-January
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-01-17.2229][2026-01-17.2229]]
+ [[https://github.com/clojars/clojars-web/pull/921][Use database data for Maven indexing]]. This uses the exported POMs from the DB instead of syncing down POMs from S3 to reduce AWS costs. ([[https://github.com/tobias][Toby Crawley]])
  
*** [[https://github.com/clojars/clojars-web/releases/tag/2026-01-24.2235][2026-01-24.2235]]
+ [[https://github.com/clojars/clojars-web/commit/5822c3d5f2001f8f8bed4f877a27d05cad24ca6b][Upgrade stale dependencies]] including logback, jackson, postgresql, and honeySQL ([[https://github.com/tobias][Toby Crawley]])
+ [[https://github.com/clojars/clojars-web/commit/9d13237c6e40cce7a4905d23cffb61e1cd316b1b][Update to nvd-clojure 5.3.0]] ([[https://github.com/tobias][Toby Crawley]])
+ [[https://github.com/clojars/clojars-web/commit/b07eaddf9bf69c490c6a2ccaa0ffae68844da409][Update to latest clj-kondo]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2026-01-25.2239][2026-01-25.2239]]  
+ [[https://github.com/clojars/clojars-web/pull/922][Use muuntaja instead of ring-middleware-format for formatting]] ([[https://github.com/tobias][Toby Crawley]])
  
** 2025-December

*** [[https://github.com/clojars/clojars-web/releases/tag/2025-12-13.2215][2025-12-13.2215]]
+ [[https://github.com/clojars/clojars-web/pull/913][Upgrade many stale dependencies; add antq make target]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2025-12-14.2217][2025-12-14.2217]]
+ [[https://github.com/clojars/clojars-web/pull/918][Upgrade to lucene 10.x]] ([[https://github.com/tobias][Toby Crawley]])
+ [[https://github.com/clojars/clojars-web/commit/71a7f1733c8955e7cf1f9ef4df1849f7882b4743][Upgrade regex to 1.1.0]] ([[https://github.com/tobias][Toby Crawley]])
+ [[https://github.com/clojars/clojars-web/commit/5b722e16d530ce57d86727b36d498ad5b7227592][Address lint errors with regex upgrade]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2025-12-14.2218][2025-12-14.2218]]
+ [[https://github.com/clojars/clojars-web/commit/be3e0a1c5d83e27636d18ccc93f30e24ae600f45][Upgrade to clj-kondo 2026.01.12]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2025-12-31.2221][2025-12-31.2221]]
+ [[https://github.com/clojars/clojars-web/commit/6008d9b73add2c38c0c738eb47203be9b01278cc][Update stale dependencies]] ([[https://github.com/tobias][Toby Crawley]])

** 2025-November
*** [[https://github.com/clojars/clojars-web/releases/tag/2025-11-20.2208][2025-11-20.2208]]
+ [[https://github.com/clojars/clojars-web/commit/1c950b45c2d24cb230cd033f3a13940968633ba4][Don't try to send email when we haven't built an email object]] ([[https://github.com/tobias][Toby Crawley]])
+ [[https://github.com/clojars/infrastructure/commit/48ddd9c5968d306b2d539473b32a024f9ef80e93][Use Java 25 in production]] ([[https://github.com/tobias][Toby Crawley]])
  
** 2025-October
*** [[https://github.com/clojars/clojars-web/releases/tag/2025-10-19.2203][2025-10-19.2203]]
+ [[https://github.com/clojars/clojars-web/commit/43b2f041b4ae994e6c39d07fce5b89b850bc692c][Build with Java 25]] ([[https://github.com/tobias][Toby Crawley]])
+ [[https://github.com/clojars/clojars-web/commit/6524e1f0cfbf086840db8c5334f8530b528438c8][Don't throw when given an invalid email on password reset]] ([[https://github.com/tobias][Toby Crawley]])
  
*** [[https://github.com/clojars/clojars-web/releases/tag/2025-10-19.2205][2025-10-19.2205]]
+ [[https://github.com/clojars/clojars-web/commit/f9bb6c85b32e248b3d03787add483cc8a2759f9d][Upgrade to Clojure 1.12.3]] ([[https://github.com/tobias][Toby Crawley]])
+ [[https://github.com/clojars/clojars-web/commit/e490258db24d6392ffba06d907ea36ad07e8eca4][Upgrade to logback 1.5.19 to address CVE-2025-11226]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2025-10-24.2207][2025-10-24.2207]]
+ [[https://github.com/clojars/clojars-web/commit/a53561b74cda4f50842121ce8a6a640d195e1183][Update sponsorship logo for Shortcut/Korey]] (with an [[https://github.com/clojars/clojars-web/commit/d46668f0e1f535f803ae2b8e110ffcef5ab9f124][additional fix]]) ([[https://github.com/tobias][Toby Crawley]])
  
** 2025-September
*** [[https://github.com/clojars/clojars-web/releases/tag/2025-09-01.2195][2025-09-01.2195]]
+ [[https://github.com/clojars/clojars-web/commit/cb3f1ba63c4c573a19a7d986916c4246561a7d22][Upgrade bouncycastle to address CVE-2025-8916]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2025-09-13.2198][2025-09-13.2198]]
+ [[https://github.com/clojars/clojars-web/pull/912][Use non-deprecated buddy base64 functions]] ([[https://github.com/tobias][Toby Crawley]])

** 2025-August
*** [[https://github.com/clojars/clojars-web/releases/tag/2025-08-13.2187][2025-08-13.2187]]
+ [[https://github.com/clojars/clojars-web/commit/3b5dda44e3bdc2903c9c50fca2a3786d6995213a][Update to the latest bouncycastle]] ([[https://github.com/tobias][Toby Crawley]])
  
*** [[https://github.com/clojars/clojars-web/releases/tag/2025-08-24.2191][2025-08-24.2191]]
+ [[https://github.com/clojars/clojars-web/commit/a72af40bb3427fc1f7e8ec83b330943ce7abac45][Prevent null characters from triggering errors on project browse]] ([[https://github.com/tobias][Toby Crawley]])

*** [[https://github.com/clojars/clojars-web/releases/tag/2025-08-25.2193][2025-08-25.2193]]
+ [[https://github.com/clojars/clojars-web/commit/a84e8b935965c699130c1659bf87d9a4f6a6a65c][Update to Clojure 1.12.2]] ([[https://github.com/tobias][Toby Crawley]])
